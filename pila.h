...
//Funcion auxiliar implementada para no repetir codigo
//Redimensiona la pila
//Pre: la pila fue creada
//Post: si la redimension falla devuelve falso caso contrario devuelve
...
void apilar_nulls(void);
void condiciones_borde(void);
#endif // _PILA_H
